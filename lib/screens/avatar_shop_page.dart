...
class _AvatarShopPageState extends State<AvatarShopPage> {
  ...
  late final List<_ShopSet> shopSets = [
    const _ShopSet(
      title: '初心學院套裝',
      description: '乾淨的臉型、短髮與 T-shirt，適合日常讀書。',
      icon: Icons.school_outlined,
      items: [
        MapEntry('faceShape', 1),
        MapEntry('hairStyle', 1),
        MapEntry('eyeStyle', 1),
        MapEntry('outfitStyle', 1),
        MapEntry('backgroundColor', 1),
      ],
    ),
    const _ShopSet(
      title: '夜讀專注套裝',
      description: '微捲髮、酷臉與外套，適合深夜專注房。',
      icon: Icons.nightlight_round,
      items: [
        MapEntry('hairStyle', 5),
        MapEntry('eyeStyle', 2),
        MapEntry('mouthStyle', 2),
        MapEntry('outfitStyle', 3),
        MapEntry('appBackground', 1),
      ],
    ),
    const _ShopSet(
      title: '活力運動套裝',
      description: '明亮表情與配件，適合運動、步數挑戰。',
      icon: Icons.local_fire_department_outlined,
      items: [
        MapEntry('faceShape', 2),
        MapEntry('eyebrowStyle', 2),
        MapEntry('mouthStyle', 1),
        MapEntry('outfitStyle', 6),
        MapEntry('accessory', 7),
        MapEntry('backgroundColor', 3),
      ],
    ),
    const _ShopSet(
      title: '星光收藏套裝',
      description: '高階主題與星星配件，適合展示在好友頁。',
      icon: Icons.auto_awesome_outlined,
      items: [
        MapEntry('hairStyle', 7),
        MapEntry('eyeStyle', 4),
        MapEntry('outfitStyle', 7),
        MapEntry('accessory', 4),
        MapEntry('appBackground', 2),
      ],
    ),
    const _ShopSet(
      title: '溫柔日常套裝',
      description: '柔和臉、溫柔眼與針織感，適合好友頁展示。',
      icon: Icons.local_florist_outlined,
      items: [
        MapEntry('faceShape', 4),
        MapEntry('hairStyle', 6),
        MapEntry('eyeStyle', 5),
        MapEntry('eyebrowStyle', 4),
        MapEntry('mouthStyle', 4),
        MapEntry('outfitStyle', 7),
        MapEntry('backgroundColor', 6),
      ],
    ),
    const _ShopSet(
      title: '自信挑戰套裝',
      description: '俐落臉、上揚眉與制服風格，適合排行榜展示。',
      icon: Icons.workspace_premium_outlined,
      items: [
        MapEntry('faceShape', 5),
        MapEntry('hairStyle', 4),
        MapEntry('eyeStyle', 3),
        MapEntry('eyebrowStyle', 5),
        MapEntry('mouthStyle', 5),
        MapEntry('outfitStyle', 5),
        MapEntry('accessory', 5),
      ],
    ),
  ];
