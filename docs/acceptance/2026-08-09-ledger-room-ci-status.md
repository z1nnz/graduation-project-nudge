...
5. Complete clean iOS Simulator and Android emulator fresh-install smoke
   artifacts. A physical iPhone, App Attest exchange, APNs receipt and App Store
   signing are deferred release-hardening work, not graduation-project gates.
